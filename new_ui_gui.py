...
################################################################################
## Form generated from reading UI file 'guiVulwJE.ui'
##
...
"}")
        ...
        self.help_btn = QPushButton(self.frame_5)
        self.help_btn.setObjectName(u"help_btn")
        icon8 = QIcon()
        icon8.addFile(u":/icons/assets/icons/help-circle.png", QSize(), QIcon.Normal, QIcon.Off)
        self.help_btn.setIcon(icon8)
        self.help_btn.setIconSize(QSize(22, 22))

        self.verticalLayout_6.addWidget(self.help_btn, 0, Qt.AlignLeft)
...
"border-style: solid ;")
        ...
        self.select_key.setStyleSheet(u"border-color: rgb(192, 28, 40);\n"
"border-width:1px;\n"
"border-style: solid ;")
        ...
        self.select_file.setStyleSheet(u"border-color: rgb(192, 28, 40);\n"
"border-width:1px;\n"
"border-style: solid ;")
...
"border-style: solid ;")
        ...
        self.help_site = QWidget()
        self.help_site.setObjectName(u"help_site")
        self.verticalLayout_25 = QVBoxLayout(self.help_site)
        self.verticalLayout_25.setSpacing(15)
        self.verticalLayout_25.setObjectName(u"verticalLayout_25")
        self.verticalLayout_25.setContentsMargins(30, 30, 30, 30)
        self.frame_20 = QFrame(self.help_site)
        ...
        self.stackWidget.addWidget(self.help_site)
        self.firstkey_site = QWidget()
        self.firstkey_site.setObjectName(u"firstkey_site")
        self.verticalLayout_22 = QVBoxLayout(self.firstkey_site)
        self.verticalLayout_22.setSpacing(15)
        self.verticalLayout_22.setObjectName(u"verticalLayout_22")
        self.verticalLayout_22.setContentsMargins(30, 30, 30, 30)
        self.frame_18 = QFrame(self.firstkey_site)
        ...
        self.firstkey_label = QLabel(self.frame_19)
        self.firstkey_label.setObjectName(u"firstkey_label")

        self.verticalLayout_24.addWidget(self.firstkey_label)

        self.firstkey_input = QLineEdit(self.frame_19)
        self.firstkey_input.setObjectName(u"firstkey_input")
        self.firstkey_input.setMaximumSize(QSize(16777215, 16777215))
        self.firstkey_input.setStyleSheet(u"border-color: rgb(192, 28, 40);\n"
"border-width:1px;\n"
"border-style: solid ;")

        self.verticalLayout_24.addWidget(self.firstkey_input)

        self.firstkey_btn = QPushButton(self.frame_19)
        self.firstkey_btn.setObjectName(u"firstkey_btn")

        self.verticalLayout_24.addWidget(self.firstkey_btn)


        self.verticalLayout_23.addWidget(self.frame_19, 0, Qt.AlignHCenter)


        self.verticalLayout_22.addWidget(self.frame_18)

        self.stackWidget.addWidget(self.firstkey_site)
...
"border-style: solid ;")
        ...
        font7 = QFont()
        font7.setFamilies([u"Quicksand Light"])
        font7.setPointSize(9)
        self.frame_3.setFont(font7)
        ...
        font8 = QFont()
        font8.setFamilies([u"Quicksand Medium"])
        font8.setBold(True)
        self.footer_label.setFont(font8)
...
"font-size:9px;}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtablewidgetitem.setText(QCoreApplication.translate("MainWindow", u"Key Name", None));
        ...
        self.label_20.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Usage:</p><p>1. Create a key (if you havent already)</p><p>2. Create a passfile (if you havent already)</p><p>3. Create or load a pass</p><p><br/>Choose a key and a file and enter the account name and the password for it</p></body></html>", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:700; font-style:italic; color:#3584e4;\">Welcome to Passwizzard!</span><span style=\" font-size:14pt; color:#3584e4;\"><br/></span><span style=\" font-size:14pt; color:#f6f5f4;\">This is your first launch. <br/>In order for the manager to work properly, you need an initial encryption key. Passwords can only be read with the corresponding key. </span></p><p align=\"center\"><span style=\" font-size:14pt; color:#e01b24;\">Keep it in a safe place !</span></p><p align=\"center\"><br/></p></body></html>", None))
        self.firstkey_label.setText(QCoreApplication.translate("MainWindow", u"Enter a Name for your first Key", None))
        self.firstkey_btn.setText(QCoreApplication.translate("MainWindow", u"Create", None))
